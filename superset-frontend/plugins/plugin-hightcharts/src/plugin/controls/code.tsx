...
export const jsConfig: ControlSetItem = {
  name: 'config',
  config: {
    ...sharedControls.entity,
    type: HandlebarsTemplateControl,
    label: t('Config'),
    description: t('Default hightcharts config to pass to the chart'),
...
export const jsInit: ControlSetItem = {
  name: 'init',
  config: {
    ...sharedControls.entity,
    type: HandlebarsTemplateControl,
    ...
    default: `const { data, element } = this;
// Do something with data and element.
// For example, you can change width/height of root element:
