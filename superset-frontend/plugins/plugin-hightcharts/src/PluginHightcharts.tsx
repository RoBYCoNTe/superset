...
import { PluginHightchartsProps, PluginHightchartsStylesProps } from './types';
...
const Styles = styled.div<PluginHightchartsStylesProps>`
...
export default function PluginHightcharts(props: PluginHightchartsProps) {
